    ...
    <div className="space-y-28">
      ...
      <section className="grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative h-[420px]">
          ...
          {/* Floating images */}
          <div className="absolute bottom-[-40px] right-[-20px] flex gap-4">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: data.storyDescription,
              }}
            />
          </div>

          <div className="grid grid-cols-2 gap-4">
            {[data.storyTemplate1, data.storyTemplate2, data.storyTemplate3]
              .filter(Boolean)
              .map((img, i) => (
                <img
                  key={i}
        ...
        <section className="space-y-12">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: data.processDescription,
              }}
            />
          </div>
      ...
      {data.inspectionTitle && (
        <section className="grid md:grid-cols-2 gap-12 items-center bg-slate-50 p-10 rounded-3xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[data.inspectionTemplate1, data.inspectionTemplate2, data.inspectionTemplate3]
              .filter(Boolean)
              .map((img, i) => (
                <img
                  key={i}
