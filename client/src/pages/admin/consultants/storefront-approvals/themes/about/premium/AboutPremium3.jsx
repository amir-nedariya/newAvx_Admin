          ...
          <div className="relative h-[420px]">
            ...
            {data.heroTemplate2?.imageUrl && (
              <img
                ...
                className="absolute bottom-[-40px] right-[-20px] w-2/3 h-56 object-cover rounded-2xl shadow-2xl border-4 border-white"
                alt=""
              />
            )}
          </div>
